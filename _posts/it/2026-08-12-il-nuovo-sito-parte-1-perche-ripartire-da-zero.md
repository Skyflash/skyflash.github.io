...
redirect_from: "/blog/progetti-personali/il-nuovo-sito-parte-1-perche-ripartire-da-zero/"
icon: fa-paint-brush
---

Stamattina ho raccontato [come ho passato il pomeriggio a rimettere in sesto le dipendenze di questo sito]({{ '/it/blog/progetti-personali/manutenzione-sito-2026/' | relative_url }}) — Ruby, npm, Bootstrap, Chart.js, tutta roba ferma al 2019 che nessuno aveva mai più toccato davvero. Quel lavoro doveva essere la fine della giornata: sito sistemato, dipendenze pulite, tutti contenti.
...
**Continua nella [parte 2]({{ '/it/blog/progetti-personali/il-nuovo-sito-parte-2-i-bug-nascosti-in-un-sito-nuovo/' | relative_url }}): i bug nascosti in un sito nuovo di zecca.**
